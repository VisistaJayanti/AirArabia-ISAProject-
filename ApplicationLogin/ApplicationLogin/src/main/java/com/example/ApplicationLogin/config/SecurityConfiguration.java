...
public class SecurityConfiguration {
    ...
    @Autowired
    AuthenticationManager  authenticationManagerx;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        CustomAuthenticationFilter customAuthenticationFilter = new CustomAuthenticationFilter(authenticationManagerx);
